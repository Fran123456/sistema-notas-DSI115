  ...
  <div class="col-md-12">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Tipo de notas</li>
      </ol>
    </nav>
  </div>
</div>
...
<div class="row ">
    <div class="col-md-12 col-sm-12 col-xs-12 text-right">
       <a class="btn btn-info mb-1" href="{{ route('crateScoreType') }}"><i class="fa fa-plus" aria-hidden="true"></i></a>
    </div>
</div>
