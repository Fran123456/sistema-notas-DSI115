...
<form method="POST" action="{{route('behaviors.update',$indicador->id)}}" enctype="multipart/form-data">
@method('PUT')
  @csrf
<div class="row">
  <div class="col-lg-12">
                    <div class="card">
                          ...
                          <div class="card-body card-block">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" required  class="form-control" placeholder="Ingrese Nombre del Indicador de Conducta , ejem MUY BUENO" value="{{$indicador->name}}">
                             </div>
                             ...
                             <div class="form-group">
                                ...
                                <br>
                                <small>*requerido</small>
                                <input type="text" name="code" required  class="form-control" placeholder="Ingrese un codigo del indicador de conducta, ejem MB(MUY BUENO)" value="{{$indicador->code}}">
                             </div>
                             <div class="form-group">
                                <label  class=" form-control-label">Descripcion</label>

                                <textarea name="description" id="" cols="30" rows="10" class="form-control"  placeholder="Agregue una Descripcion">{{$indicador->description}}</textarea>
                             </div>
